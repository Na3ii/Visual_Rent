<fieldset class="formulario__fieldset">
    ...
    <?php if(isset($categoria->imagen_actual)) { ?>
        ...
        <div class="formulario__imagen-miniatura">
            <picture>
                <source srcset="/img/categoria-productos/<?php echo $categoria->imagen; ?>.webp" type="image/webp">
                <source srcset="/img/categoria-productos/<?php echo $categoria->imagen; ?>.png" type="image/png">
                <img src="/img/categoria-productos/<?php echo $categoria->imagen; ?>.png" alt="imagen producto">
            </picture>
        </div>
    <?php } ?>
</fielset>

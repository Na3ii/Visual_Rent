...
<html lang="es">
<?php if (isset($vista)) : ?>
    <?php if ($vista === 'servicios') : ?>
        <!-- JSON-LD para Servicios -->
        <meta name="description" content="Visual Rent ofrece soluciones creativas y tecnológicas para tus eventos: diseño gráfico impactante, asistencia técnica en terreno, desarrollo de software personalizado para pantallas interactivas, DJs para ambientación sonora y sistemas de iluminación perimetral inteligentes."> 
...
<?php endif; ?>
<head>
    <meta name="description" content="Arriendo de equipos audiovisuales profesionales para tus eventos. Experiencias inolvidables con Visual Rent. Cotiza online.">
    ...
    <meta property="og:url" content="https://visualrent.cl">
    ...
    <meta name="twitter:image" content="https://visualrent.cl/images/og-image.jpg">
    ...
    <title>Visual Rent - <?php echo $titulo; ?></title>
    ...
    <link rel="canonical" href="https://visualrent.cl/" />

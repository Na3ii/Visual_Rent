<main class="pago__contenedor">
  <h2 class="pago__heading">Medios de Pago</h2>

  <p class="pago__parrafo">
    En <strong>VisualRent.cl</strong> buscamos ofrecerte flexibilidad y seguridad al momento de realizar tus pagos. Contamos con distintos métodos para facilitar el proceso de arriendo de nuestros productos.
  </p>
  ...
  <p class="pago__parrafo">
    Este sistema nos permite asegurar tu fecha y garantizar el compromiso con el evento, al mismo tiempo que te brinda confianza y transparencia en el proceso.
  </p>
  ...
  <p class="pago__parrafo">
    Para mayor información o consultas sobre medios de pago, puedes escribirnos a <a href="mailto:contacto@visualrent.cl">contacto@visualrent.cl</a>.
  </p>
</main>